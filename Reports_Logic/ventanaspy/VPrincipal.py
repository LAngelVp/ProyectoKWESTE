# Form implementation generated from reading ui file 'c:\Users\Angel Rodriguez\LUIS_ANGEL_VALLEJO\ProccessRMPG73\App\Front\ventanasui\VPrincipal.ui'
#
...
class Ui_VPrincipal(object):
    def setupUi(self, VPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\LUIS_ANGEL_VALLEJO\\ProccessRMPG73\\App\\Front\\ventanasui\\Source/KWE.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\LUIS_ANGEL_VALLEJO\\ProccessRMPG73\\App\\Front\\ventanasui\\../../../../../Downloads/rutas.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
